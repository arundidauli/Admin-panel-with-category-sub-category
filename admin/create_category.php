...
$sql=mysqli_query($connection,"insert into category(category_name,cat_pic) values('".$category."','".$file."')");
if ($sql) {
	$_SESSION['msg']="Category Created !!";
} else{
	$_SESSION['msg']="Category not create!!";
}
}
...
if(isset($_GET['del']))
{
$dele= mysqli_query($connection,"delete from category where cat_id = '".$_GET['cat_id']."'");
if ($dele) {
	$_SESSION['delmsg']="Category deleted !!";

}else{
		$_SESSION['delmsg']="Something went wrong !!";
...
<div class="panel-body " >
<form method="post" action="create_category.php" class="form-horizontal" enctype="multipart/form-data">
...
<td align="center"><img src="uploads/<?php echo htmlentities($row['pic']);?>" height="30px" width="60px"></a></td>
<td>

<a class = "btn btn-danger btn-xs " href="create_category.php?cat_id=<?php echo $row['cat_id']?>&del=delete"><span class="glyphicon glyphicon-trash"></a>
</td>
</tr>
<?php $cnt=$cnt+1; } ?>
</tbody>
